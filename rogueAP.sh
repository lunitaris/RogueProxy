...
if [ "$USE_PROXY" == "yes" ]; then
	...
	iptables -t nat -A PREROUTING ! -s 127.0.0.1 -i at0 -p tcp --dport 80 -j DNAT --to 127.0.0.1:8080
...
[[ $givenet == "y" ]] && iptables -t nat -A POSTROUTING -p tcp ! --dport 8080 -o $iface_net -j MASQUERADE
